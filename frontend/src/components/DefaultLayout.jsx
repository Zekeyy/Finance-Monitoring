...
function DefaultLayout() {
    ...
    const [headerText, setHeaderText] = useState(() => {
        ...
        if (path.includes('/user-lists')) return "User Management";
    ...
    useEffect(() => {
        ...
        } else if (path.includes('/user-lists')) {
    ...
    return (
        <div id="defaultLayout" className="flex h-screen">
            ...
            >
                ...
                <Link to="/dashboard" onClick={() => { handleHeaderChange("Dashboard"); }}>
                ...
                <Link to="/transaction" onClick={() => { handleHeaderChange("Add Transaction"); }}>
                    <span className="flex items-center text-white text-xl font-semibold py-2 px-4 rounded-md hover:bg-blue-500 hover:text-white transition-all duration-300 ease-in-out">
                ...
                <Link to="/transaction-history" onClick={() => { handleHeaderChange("Transaction History"); }}>
                    <span className="flex items-center text-white text-xl font-semibold py-2 px-4 rounded-md hover:bg-blue-500 hover:text-white transition-all duration-300 ease-in-out">
